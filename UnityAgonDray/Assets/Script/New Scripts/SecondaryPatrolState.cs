...
public class SecondaryPatrolState : StateMachineBehaviour
{
    float timer;
    ...
    {
        AudioManager.instance.Stop("ChaseMusic2");
        player = GameObject.FindGameObjectWithTag("Player").transform;
        agent = animator.GetComponent<NavMeshAgent>();
        agent.speed = 2.5f;
        timer = 0;

        GameObject go = GameObject.FindGameObjectWithTag("WaypointsSecondary");
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            AudioManager.instance.Play("ChaseMusic2");
